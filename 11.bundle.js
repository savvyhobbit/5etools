(window.webpackJsonp=window.webpackJsonp||[]).push([[11],{101:function(e,t,a){"use strict";a.r(t);var i=a(7),s=(a(63),a(70),a(145));a(75),a(76);class d extends i.a{static get properties(){return{tabs:{type:Array,observer:"tabsChanged"},initialSelectedIndex:{type:Number,value:0}}}tabsChanged(){this.tabs.length&&setTimeout(()=>{this.tabBar=new s.a(this.$.tabs),this.$.tabs.addEventListener("MDCTabBar:activated",e=>{this.handleTabChange(e.detail.index)}),this.tabBar.activateTab(this.initialSelectedIndex)},0)}handleTabChange(e){this.dispatchEvent(new CustomEvent("tabChange",{bubbles:!0,composed:!0,detail:{index:e}}))}static get template(){return i.b`
    ...
    `}}customElements.define("dnd-switch",d)},142:function(e,t,a){var i={"./dnd-character-builder-attributes":[126,4,8],"./dnd-character-builder-attributes.js":[126,4,8],"./dnd-character-builder-background-race":[122,9],"./dnd-character-builder-background-race.js":[122,9],"./dnd-character-builder-class":[129,3,4,5],"./dnd-character-builder-class.js":[129,3,4,5],"./dnd-character-builder-equipment":[125,3,6],"./dnd-character-builder-equipment.js":[125,3,6],"./dnd-character-builder-spells":[127,3,7],"./dnd-character-builder-spells.js":[127,3,7]};function s(e){if(!a.o(i,e))return Promise.resolve().then((function(){var t=new Error("Cannot find module '"+e+"'");throw t.code="MODULE_NOT_FOUND",t}));var t=i[e],s=t[0];return Promise.all(t.slice(1).map(a.e)).then((function(){return a(s)}))}s.keys=function(){return Object.keys(i)},s.id=142,e.exports=s}}]);
