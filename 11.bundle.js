(window.webpackJsonp=window.webpackJsonp||[]).push([[11],{127:function(e,t,i){"use strict";i.r(t);var a=i(7),d=i(17),c=i(111),o=i(1);class r extends a.a{static get properties(){return{selectedBackground:{type:String,value:""},backgroundSkillProfOptions:{type:Object,value:[]},defaultBackgroundSkillProf:{type:String,value:""},selectedRace:{type:String,value:""},raceAttributeOptions:{type:Object,value:[]},defaultRaceAttribute:{type:String,value:""},isEditMode:{type:Boolean,value:!1},backgroundName:{type:String,value:""},raceName:{type:String,value:""}}}connectedCallback(){super.connectedCallback(),this.characterChangeHandler=e=>{let t=e.detail.character;this.updateFromCharacter(t)},this.updateFromCharacter(Object(d.F)()),Object(d.l)().addEventListener("character-selected",this.characterChangeHandler),this.editModeHandler=e=>{this.isEditMode=e.detail.isEditMode},Object(c.b)().addEventListener("editModeChange",this.editModeHandler),this.isEditMode=Object(c.c)()}disconnectedCallback(){super.disconnectedCallback(),Object(d.l)().removeEventListener("character-selected",this.characterChangeHandler),Object(c.b)().removeEventListener("editModeChange",this.editModeHandler)}async updateFromCharacter(e){this.selectedBackground=e.background,this.backgroundName=this.selectedBackground.name,this.selectedRace=e.race,this.raceName=this.selectedRace.name;let t=await Object(d.j)();t&&t.choose?(this.backgroundSkillProfOptions=t.choose.from,this.backgroundSkillProfChoices=t.choose.count||1,this.backgroundSkillProfSelections=e.backgroundSkillProficiencies):(this.backgroundSkillProfOptions=void 0,this.backgroundSkillProfChoices=void 0,this.backgroundSkillProfSelections=void 0);let i=await Object(d.i)(t);this.defaultBackgroundSkillProf=i.map(e=>Object(o.util_capitalizeAll)(e)).join(", ");let a=await Object(d.E)();a&&a.choose?(this.raceAttributeOptions=a.choose.from.map(e=>e.toUpperCase()),this.raceAttributeChoices=a.choose.count||1,this.raceAttributeSelections=e.raceAttributes):(this.raceAttributeOptions=void 0,this.raceAttributeChoices=void 0,this.raceAttributeSelections=void 0);let c=await Object(d.D)(a);this.defaultRaceAttribute=c.map(e=>{let t=e[0].toLowerCase(),i=e[1];return t.toUpperCase()+" "+Object(o.absInt)(i)}).join(", "),Object(o.initCollapseToggles)(this.shadowRoot),this.dispatchEvent(new CustomEvent("loadingChange",{bubbles:!0,composed:!0}))}_backgroundSkillAddCallback(e){Object(d.Y)(e)}_raceAttributeAddCallback(e){Object(d.jb)(e)}_getRaceLink(e){let t=[e.name];e.source&&t.push(e.source);let i=Object(o.encodeForHash)(t);return e?"#/races/"+i:"#/races"}_getBackgroundLink(e){let t=[e.name];e.source&&t.push(e.source);let i=Object(o.encodeForHash)(t);return e?"#/backgrounds/"+i:"#/backgrounds"}_showEmpty(e,t){return!e&&!t}_exists(){for(let e of arguments)if(e&&(e.constructor!==Object||Object.entries(e).length>0)&&(!Array.isArray(e)||e.length>0))return!0;return!1}static get template(){return a.b`
