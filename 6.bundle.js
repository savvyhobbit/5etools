(window.webpackJsonp=window.webpackJsonp||[]).push([[6],{166:function(e,t,a){"use strict";a(90),a(42);var i=a(103),n=a(56),l=a(2);
/**
 * @license
...
`;Object(l.c)("vaadin-number-field",[n.a,i.a,s],{moduleId:"lumo-number-field"});a(72);var o=a(3),r=a(32),d=a(33),c=a(57),m=a(102),h=a(55),p=a(73);
/**
 * @license
 * Copyright (c) 2021 - 2022 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */
Object(l.c)("vaadin-number-field",p.a,{moduleId:"vaadin-number-field-styles"});class u extends(Object(m.a)(Object(l.a)(Object(r.a)(o.a)))){static get is(){return"vaadin-number-field"}static get template(){return o.b`
      <style>
 ...
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */
class g extends u{static get is(){return"vaadin-integer-field"}constructor(){super(),this.allowedCharPattern="[-+\\d]"}_valueChanged(e,t){if(""!==e&&!this.__isInteger(e))return console.warn(`Trying to set non-integer value "${e}" to <vaadin-integer-field>. Clearing the value.`),void(this.value="");super._valueChanged(e,t)}_stepChanged(e,t){if(null!=e&&!this.__hasOnlyDigits(e))return console.warn(`<vaadin-integer-field> The \`step\` property must be a positive integer but \`${e}\` was provided, so the property was reset to \`null\`.`),void(this.step=null);super._stepChanged(e,t)}__isInteger(e){return/^(-\d)?\d*$/.test(String(e))}__hasOnlyDigits(e){return/^\d+$/.test(String(e))}}customElements.define(g.is,g);console.warn('WARNING: Since Vaadin 23.2, "@vaadin/vaadin-text-field" is deprecated. Use "@vaadin/integer-field" instead.')},168:function(e,t,a){"use strict";a(124);
/**
 * @license
 ...
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */
a(121).a;console.warn('WARNING: Since Vaadin 23.2, "@vaadin/vaadin-checkbox" is deprecated. Use "@vaadin/checkbox" instead.')},180:function(e,t,a){"use strict";a.r(t);var i=a(3),n=(a(122),a(168),a(166),a(100),a(1)),l=a(31),s=a(0),o=a(165),r=a(104);class d extends i.a{static get properties(){return{isEditMode:{type:Boolean,value:!1},customRolls:{type:Array}}}connectedCallback(){super.connectedCallback(),this.damageTypes=s.k,this.characterChangeHandler=e=>{let t=e.detail.character;this.updateFromCharacter(t)},this.updateFromCharacter(Object(l.O)()),Object(l.m)().addEventListener("character-selected",this.characterChangeHandler),this.editModeHandler=e=>{this.isEditMode=e.detail.isEditMode},Object(o.b)().addEventListener("editModeChange",this.editModeHandler),this.isEditMode=Object(o.c)()}disconnectedCallback(){super.disconnectedCallback(),Object(l.m)().removeEventListener("character-selected",this.characterChangeHandler),Object(o.b)().removeEventListener("editModeChange",this.editModeHandler)}async updateFromCharacter(e){this.customRolls=e.customRolls?Object(n.cloneDeep)(e.customRolls):[],this.dispatchEvent(new CustomEvent("loadingChange",{bubbles:!0,composed:!0}))}__exists(){for(let e of arguments)if(e&&(e.constructor!==Object||Object.entries(e).length>0)&&(!Array.isArray(e)||e.length>0))return!0;return!1}__abs(e){return e>=0?"+"+e:e}_makeRoll(e){if(!this.isEditMode){let t=e.model.__data.item;t.noHitRoll||Object(r.d)(t.name+" (to hit)",t.toHit,this.$.advMod.checked,this.$.disadvMod.checked),t.damages.forEach((e,a)=>{Object(r.b)(`${t.name} (${e.type} damage)`,e.roll),setTimeout(()=>{},500*(a+1))})}}_rollChangeHandler(e){const t=Object(n.findInPath)(".roll",e).getAttribute("index"),a=parseInt(t,10);Object(l.pb)(this.customRolls[a],a)}_addRoll(){Object(l.pb)({name:"",toHit:0,noHitRoll:!1,damages:[{roll:"",type:""}]},this.customRolls.length),this.isEditMode||Object(o.a)(!0),setTimeout(()=>{const e=this.shadowRoot.querySelectorAll(".roll");e[e.length-1].scrollIntoView()},1)}_removeRoll(e){const t=Object(n.findInPath)(".roll",e).getAttribute("index"),a=parseInt(t,10);Object(l.bb)(a)}_addDamage(e){const t=Object(n.findInPath)(".roll",e).getAttribute("index"),a=parseInt(t,10),i=this.customRolls[a];i.damages.push({roll:"",type:""}),Object(l.pb)(i,a)}_removeDamage(e){const t=Object(n.findInPath)(".roll",e).getAttribute("index"),a=parseInt(t,10),i=Object(n.findInPath)(".roll__damage",e).getAttribute("index"),s=parseInt(i,10);Object(l.cb)(a,s)}_or(e,t){return e||t}_orNot(e,t){return e||!t}_isTruthy(e){return!!e}_modChange(e){"advMod"===e.currentTarget.id?this.$.disadvMod.checked=!1:this.$.advMod.checked=!1}static get template(){return i.b`
