(window.webpackJsonp=window.webpackJsonp||[]).push([[15],{103:function(e,t,a){"use strict";a.r(t);var i=a(7),s=(a(63),a(71),a(154));a(80),a(78);class n extends i.a{static get properties(){return{tabs:{type:Array,observer:"tabsChanged"},initialSelectedIndex:{type:Number,value:0,observer:"selectedIndexChange"}}}tabsChanged(){this.tabs.length&&(this.tabBar&&this.$.tabs.removeEventListener("MDCTabBar:activated",this.handleTabChange),setTimeout(()=>{this.tabBar=new s.a(this.$.tabs),this.$.tabs.addEventListener("MDCTabBar:activated",this.handleTabChange),this.tabBar.activateTab(this.initialSelectedIndex)},10))}selectedIndexChange(){this.tabBar&&this.initialSelectedIndex&&this.tabBar.activateTab(this.initialSelectedIndex)}handleTabChange(e){const t=e.detail.index;this.dispatchEvent(new CustomEvent("tabChange",{bubbles:!0,composed:!0,detail:{index:t}}))}static get template(){return i.b`
    ...
    `}}customElements.define("dnd-switch",n)},151:function(e,t,a){var i={"./dnd-character-builder-abilities":[130,3,7],"./dnd-character-builder-abilities.js":[130,3,7],"./dnd-character-builder-attributes":[131,3,10],"./dnd-character-builder-attributes.js":[131,3,10],"./dnd-character-builder-background-race":[132,5,13],"./dnd-character-builder-background-race.js":[132,5,13],"./dnd-character-builder-class":[138,4,3,11],"./dnd-character-builder-class.js":[138,4,3,11],"./dnd-character-builder-equipment":[139,4,6,12],"./dnd-character-builder-equipment-item-detail":[125,6],"./dnd-character-builder-equipment-item-detail.js":[125,6],"./dnd-character-builder-equipment.js":[139,4,6,12],"./dnd-character-builder-rolls":[135,3,8],"./dnd-character-builder-rolls.js":[135,3,8],"./dnd-character-builder-spells":[136,4,3,9],"./dnd-character-builder-spells.js":[136,4,3,9],"./dnd-character-builder-suboptions":[123,5],"./dnd-character-builder-suboptions.js":[123,5]};function s(e){if(!a.o(i,e))return Promise.resolve().then((function(){var t=new Error("Cannot find module '"+e+"'");throw t.code="MODULE_NOT_FOUND",t}));var t=i[e],s=t[0];return Promise.all(t.slice(1).map(a.e)).then((function(){return a(s)}))}s.keys=function(){return Object.keys(i)},s.id=151,e.exports=s}}]);
