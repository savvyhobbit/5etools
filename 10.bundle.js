(window.webpackJsonp=window.webpackJsonp||[]).push([[10],{135:function(e,t,a){"use strict";a.r(t);var i=a(3),s=(a(26),a(29),a(164));a(89),a(70);class n extends i.a{static get properties(){return{tabs:{type:Array,observer:"tabsChanged"},initialSelectedIndex:{type:Number,value:0,observer:"selectedIndexChange"}}}tabsChanged(){this.tabs.length&&(this.tabBar&&this.$.tabs.removeEventListener("MDCTabBar:activated",this.handleTabChange),setTimeout(()=>{this.tabBar=new s.a(this.$.tabs),this.$.tabs.addEventListener("MDCTabBar:activated",this.handleTabChange),this.tabBar.activateTab(this.initialSelectedIndex)},10))}selectedIndexChange(){this.tabBar&&this.initialSelectedIndex&&this.tabBar.activateTab(this.initialSelectedIndex)}handleTabChange(e){const t=e.detail.index;this.dispatchEvent(new CustomEvent("tabChange",{bubbles:!0,composed:!0,detail:{index:t}}))}_iconClass(e){return"mdc-tab__icon fas fa-"+e}static get template(){return i.b`
    ...
    `}}customElements.define("dnd-switch",n)},162:function(e,t,a){var i={"./dnd-character-builder-abilities":[152,2],"./dnd-character-builder-abilities.js":[152,2],"./dnd-character-builder-attributes":[153,4],"./dnd-character-builder-attributes.js":[153,4],"./dnd-character-builder-background-race":[154,0,8],"./dnd-character-builder-background-race.js":[154,0,8],"./dnd-character-builder-class":[159,0,7],"./dnd-character-builder-class.js":[159,0,7],"./dnd-character-builder-equipment":[158,1,5],"./dnd-character-builder-equipment-item-detail":[149,1],"./dnd-character-builder-equipment-item-detail.js":[149,1],"./dnd-character-builder-equipment.js":[158,1,5],"./dnd-character-builder-rolls":[156,6],"./dnd-character-builder-rolls.js":[156,6],"./dnd-character-builder-spells":[157,3],"./dnd-character-builder-spells.js":[157,3],"./dnd-character-builder-suboptions":[148,0],"./dnd-character-builder-suboptions.js":[148,0]};function s(e){if(!a.o(i,e))return Promise.resolve().then((function(){var t=new Error("Cannot find module '"+e+"'");throw t.code="MODULE_NOT_FOUND",t}));var t=i[e],s=t[0];return Promise.all(t.slice(1).map(a.e)).then((function(){return a(s)}))}s.keys=function(){return Object.keys(i)},s.id=162,e.exports=s}}]);
