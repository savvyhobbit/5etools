...
const c=document.createElement("template");c.innerHTML="<custom-style>\n  <style>\n    @font-face {\n      font-family: \"vaadin-grid-tree-icons\";\n      src: url(data:application/font-woff;charset=utf-8;base64,) format('woff');\n      font-weight: normal;\n      font-style: normal;\n    }\n  </style>\n</custom-style>",document.head.appendChild(c.content);class d extends(Object(r.a)(Object(i.a)(l.a))){static get template(){return n.a`
    ...
    <slot></slot>
`}static get is(){return"vaadin-grid-tree-toggle"}static get properties(){return{level:{type:Number,value:0,observer:"_levelChanged"},leaf:{type:Boolean,value:!1,reflectToAttribute:!0},expanded:{type:Boolean,value:!1,reflectToAttribute:!0,notify:!0}}}ready(){super.ready(),this.addEventListener("click",e=>this._onClick(e))}_onClick(e){this.leaf||(e.preventDefault(),this.expanded=!this.expanded)}_levelChanged(e){const t=Number(e).toString();this.style["---level"]=t,this._debouncerUpdateLevel=o.a.debounce(this._debouncerUpdateLevel,p.c,()=>this.updateStyles({"---level":t}))}}customElements.define(d.is,d);var h=s(18),m=s(32),u=s(109),g=s(117),A=s(1),f=s(5);s(112),s(81);class v extends l.a{static get properties(){return{spellsKnown:{type:Object,value:{}},preparedSpells:{type:Object,value:{}},noContentMessage:{type:Boolean,value:!1},isEditMode:{type:Boolean,value:!1},filterStr:{type:String,value:"",observer:"_filterChange"}}}_filterChange(){this.filterStr.length?(this.oldExpanded||(this.oldExpanded=this.$.grid.expandedItems),this.expandAll(),this.$.grid.clearCache()):(this.oldExpanded&&(this.$.grid.expandedItems=this.oldExpanded,this.oldExpanded=void 0),this.$.grid.clearCache())}connectedCallback(){super.connectedCallback(),this.characterChangeHandler=e=>{let t=e.detail.character;this.updateFromCharacter(t)},this.refresh=!0,this.updateFromCharacter(Object(h.G)()),Object(h.m)().addEventListener("character-selected",this.characterChangeHandler),this.editModeHandler=e=>{this.isEditMode=e.detail.isEditMode,this.refresh=!0,this.updateFromCharacter(Object(h.G)())},Object(u.b)().addEventListener("editModeChange",this.editModeHandler),this.isEditMode=Object(u.c)()}disconnectedCallback(){super.disconnectedCallback(),Object(h.m)().removeEventListener("character-selected",this.characterChangeHandler),Object(u.b)().removeEventListener("editModeChange",this.editModeHandler)}ready(){super.ready(),this.multiclassSlotsDef=[[2],[3],[4,2],[4,3],[4,3,2],[4,3,3],[4,3,3,1],[4,3,3,2],[4,3,3,3,1],[4,3,3,3,2],[4,3,3,3,2,1],[4,3,3,3,2,1],[4,3,3,3,2,1,1],[4,3,3,3,2,1,1],[4,3,3,3,2,1,1,1],[4,3,3,3,2,1,1,1],[4,3,3,3,2,1,1,1,1],[4,3,3,3,3,1,1,1,1],[4,3,3,3,3,2,1,1,1],[4,3,3,3,3,2,2,1,1]],setTimeout(()=>{this.$.grid.dataProvider=((e,t)=>{const s=e.page*e.pageSize;let l=e.parentItem?e.parentItem.children:this.spellDisplay;if(this.filterStr.length&&(l=l.filter(e=>this.hasDecendentWithFilter(e,this.filterStr.toLowerCase()))),l&&l.length){t(l.slice(s,s+e.pageSize),l.length)}}).bind(this)},0)}hasDecendentWithFilter(e,t){if(!e.name||e.name.toLowerCase().indexOf(t)>-1)return!0;const s=e.length?e:e.children;if(s&&s.length)for(let e of s)return this.hasDecendentWithFilter(e,t);return!1}expandAll(){this.$.grid.expandedItems=this.findExpandables(this.spellDisplay)}findExpandables(e,t=[]){"level"!==e.id&&"class"!==e.id||t.push(e);const s=e.length?e:e.children;if(s&&s.length)for(let e of s)return this.findExpandables(e,t);return t}async updateSpellStats(e,t){if(t&&e){const s=[],l=Object.entries(t).reduce((e,[t,s])=>e+s,0),n=Object(A.getProfBonus)(l);for(const[l,a]of Object.entries(t)){const t=e[l];if(t.casterProgression){const e=s.find(e=>t.spellcastingAbility===e.spellcastingAbility);if(e)e.classes.push(l);else{const e=await Object(h.g)(t.spellcastingAbility),a=e+n,o=8+a;s.push({classes:[l],mod:e,spellAttackBonus:a,dc:o,spellcastingAbility:t.spellcastingAbility})}}}this.spellMods=s}else this.spellMods=[]}async updateFromCharacter(e){if(e&&this.refresh){this.noContentMessage=!0;const t=await Object(h.s)(e),s=Object(h.r)(e),l=[],n={};let a=[];this.updateSpellStats(t,s);for(const[o,r]of Object.entries(s)){const s=t[o];if(s.casterProgression){let t;this.noContentMessage=!1;let i,p,c,d="known";if(s.classTableGroups.forEach(e=>{if(e.colLabels&&e.colLabels.length){const s=e.colLabels.findIndex(e=>e.toLowerCase().indexOf("spells known")>-1);s>-1&&e.rows&&e.rows.length>r-1&&(t=e.rows[r-1][s]);const l=e.colLabels.findIndex(e=>e.toLowerCase().indexOf("cantrips known")>-1);l>-1&&e.rows&&e.rows.length>r-1&&(i=e.rows[r-1][l]);const n=e.colLabels.findIndex(e=>e.toLowerCase().indexOf("slot level")>-1);if(n>-1&&e.rows&&e.rows.length>r-1){const t=e.rows[r-1][n].match(/(\d+)/g);t&&t.length&&(p=parseInt(t[0]))}const a=e.colLabels.findIndex(e=>e.toLowerCase().indexOf("spell slots")>-1);a>-1&&e.rows&&e.rows.length>r-1&&(c=e.rows[r-1][a])}}),void 0===t){d="prepared";const e="full"===s.casterProgression?1:.5,l=await Object(h.g)(s.spellcastingAbility);t=Math.floor(r*e)+l,t=t<1?1:t}let u=await Object(m.a)("spells",{key:"classes.fromClassList",value:{name:o,source:s.source}});const g=Object(h.K)(s);if(r>=g){const t=e.subclasses&&e.subclasses[o]?e.subclasses[o].shortName:"";if(t){let l=await Object(m.a)("spells",{key:"classes.fromSubclass",value:{"subclass.name":t,"class.name":o,"class.source":s.source}});if("Divine Soul"===t){let s=Object(h.J)(o.toLowerCase(),t.toLowerCase(),r,"Divine Magic Affinity",e);l=s?l.filter(e=>s.indexOf(e.name)>-1):[]}l=l.map(e=>({...e,isSubclassSpell:!0})),u=[...new Set(u.concat(l))]}if("Divine Soul"===t){let e=await Object(m.a)("spells",{key:"classes.fromClassList",value:{name:"cleric",source:"phb"}});u=[...new Set(u.concat(e))]}}const A=s.classTableGroups.find(e=>"Spell Slots per Spell Level"===e.title);let f;if(A)f=A.rows[r-1].filter(e=>0!==e);else{f=[];for(let e=0;e<p;e++)f.push(0)}const v=i?0:1;i&&(f=[0].concat(f));let b=JSON.parse(JSON.stringify(e.preparedSpells)),w=JSON.parse(JSON.stringify(e.preparedCantrips));e.preparedSpells[o]={},e.preparedCantrips[o]={};const x=f.map((t,s)=>{if(-1!==t){let n=u.filter(e=>e.level===s+v).sort((e,t)=>e.name<t.name?-1:e.name>t.name?1:0).map(t=>{const l=s+v===0,n=l?Object(h.N)(o,t,w):Object(h.N)(o,t,b);return n&&(l?e.preparedCantrips[o][t.name]={name:t.name,source:t.source}:e.preparedSpells[o][t.name]={name:t.name,source:t.source}),this.isEditMode||n||t.isSubclassSpell?{id:"spell",name:t.name,children:[{...t,hasChildren:!1,id:"spelldef",parentClass:o,parentLevel:s+v}],hasChildren:!0,parentClass:o,parentLevel:s+v,isCantrip:l,isSubclassSpell:t.isSubclassSpell,isWarlock:!!p}:void 0}).filter(e=>void 0!==e);const a={id:"level",level:s+v,spellSlots:t,currentSlots:Object(h.I)(s+v),children:n,hasChildren:n.length>0,parentClass:o,isWarlock:!!p};return this.$.grid.expandedItems.some(e=>"level"===e.id&&e.level===a.level&&e.parentClass===a.parentClass)&&l.push(a),a}return null}).filter(e=>null!==e);if(n[o]={current:e.preparedSpells&&e.preparedSpells[o]?Object.keys(e.preparedSpells[o]):[],max:t,type:d,maxCantrips:i,currentCantrips:e.preparedCantrips&&e.preparedCantrips[o]?Object.keys(e.preparedCantrips[o]):[]},x.length){const e={id:"class",className:o,level:r,hasCantrips:v,children:x,spellsKnown:t,hasChildren:x.length>0,spellPrepType:d,multiclassingLevels:Math.floor(("full"===s.casterProgression?1:.5)*r),isWarlock:!!p,warlockSpellLevel:p,warlockSpellSlots:c};l.push(e),a.push(e)}}}if(a.sort((e,t)=>e.children.length-t.children.length),!this.isEditMode){let t=[];if(a.length){let s,l,n=0,o=-1;for(let e of a)e.isWarlock?(s=e.warlockSpellLevel,l=e.warlockSpellSlots):(n+=e.multiclassingLevels,o++),e.children.forEach((s,l)=>{const n=l+e.hasCantrips;t[n]?s.children[l]&&(t[n].children=t[n].children.concat(s.children)):t[n]=s});t=t.filter(e=>void 0!==e);const r=0===t[0].level;if(o>0){const e=this.multiclassSlotsDef[n+1];for(let s=r?1:0;s<e.length;s++){const l=e[s-(r?1:0)];t[s]?t[s].spellSlots=l:t.push({children:[],currentSlots:Object(h.I)(s+1-(r?1:0)),hasChildren:!1,id:"level",isWarlock:!1,level:s,spellSlots:l})}}s&&(t[s-(r?0:1)].warlockSpellSlots=l,t[s-(r?0:1)].currentWarlockSlots=e.warlockSpellSlots||0)}a=t}this.refresh=!1,Object(h.V)(e),this.spellsKnown=n,this.spellDisplay=a,this.expandedItems=l,this.dispatchEvent(new CustomEvent("loadingChange",{bubbles:!0,composed:!0})),this.$.grid.clearCache()}}_renderSpell(e){return Object(g.spellHtml)(e)}_toggleSpellPrepared(e){e.preventDefault(),e.stopPropagation();if(!e.model.item.isSubclassSpell&&this.isEditMode){if(e.model.item.isCantrip)this._toggleCantripPrepared(e);else{const t=e.model.item.parentClass,s=e.model.item.children[0],l=this._isPreparedSpell(this.spellsKnown,t,s.name),n=this._currentSpellsKnownCount(t,this.spellsKnown),a=this._maxSpellsKnownCount(t,this.spellsKnown);if((l||n<a)&&"spelldef"===s.id){let e=JSON.parse(JSON.stringify(this.spellsKnown));if(l){const l=e[t].current.indexOf(s.name);e[t].current.splice(l,1)}else e[t].current.push(s.name);this.spellsKnown=e,Object(h.qb)(t,s)}else n>=a&&this._flashPreparedButton(Object(A.findInPath)("button",e))}}}_toggleCantripPrepared(e){e.preventDefault(),e.stopPropagation();const t=e.model.item.parentClass,s=e.model.item.children[0],l=this._isPreparedCantrip(this.spellsKnown,t,s.name),n=this._currentCantripsKnownCount(t,this.spellsKnown),a=this._maxCantripsKnownCount(t,this.spellsKnown);if((l||n<a)&&"spelldef"===s.id){let e=JSON.parse(JSON.stringify(this.spellsKnown));if(l){const l=e[t].currentCantrips.indexOf(s.name);e[t].currentCantrips.splice(l,1)}else e[t].currentCantrips.push(s.name);this.spellsKnown=e,Object(h.lb)(t,s)}else n>=a&&this._flashPreparedButton(Object(A.findInPath)("button",e))}_flashPreparedButton(e){e&&(e.classList.add("transition-bg"),e.classList.add("flash-error"),setTimeout(()=>{e.classList.remove("flash-error"),setTimeout(()=>{e.classList.remove("transition-bg")},200)},200))}_toggleSpellSlot(e){e.preventDefault(),e.stopPropagation();const t=Object(A.findInPath)(".checkbox-wrap",e),s=!!Object(A.findInPath)("[warlock-spell]",e),l=s?e.model.item.currentWarlockSlots:e.model.item.currentSlots,n=s?e.model.item.warlockSpellSlots:e.model.item.spellSlots,a=e.model.item.level;if(t){!t.children[0].checked&&l<n?s?e.model.item.currentWarlockSlots=l+1:e.model.item.currentSlots=l+1:l>0&&(s?e.model.item.currentWarlockSlots=l-1:e.model.item.currentSlots=l-1)}else l<n?s?e.model.item.currentWarlockSlots=l+1:e.model.item.currentSlots=l+1:l>0&&(s?e.model.item.currentWarlockSlots=l-1:e.model.item.currentSlots=l-1);s?(this._setSpellSlotsChecked(e.model.item.currentWarlockSlots,Object(A.findInPath)(".slot-checkboxes",e)),Object(h.jb)(a,e.model.item.currentWarlockSlots,void 0,!0)):(this._setSpellSlotsChecked(e.model.item.currentSlots,Object(A.findInPath)(".slot-checkboxes",e)),Object(h.jb)(a,e.model.item.currentSlots))}_setSpellSlotsChecked(e,t){const s=t.querySelectorAll("vaadin-checkbox");for(let t=0;t<s.length;t++)s[t].checked=t<e}_isPreparedClass(e,t,s){const l=t.parentClass,n=t.name,a=t.isCantrip,o=t.isSubclassSpell;if(o)return s?"spell-button always-prepared edit-mode":"spell-button always-prepared";return(a?this._isPreparedCantrip(e,l,n):this._isPreparedSpell(e,l,n,o))?s?"spell-prepared spell-button edit-mode":"spell-prepared spell-button":s?"spell-button edit-mode":"spell-button"}_isPreparedSpell(e,t,s,l){return l||e[t]&&e[t].current&&e[t].current.length&&e[t].current.indexOf(s)>-1}_isPreparedCantrip(e,t,s){return e[t]&&e[t].currentCantrips&&e[t].currentCantrips.length&&e[t].currentCantrips.indexOf(s)>-1}_isPreparedText(e,t){const s=t.parentClass,l=t.name,n=t.isCantrip,a=t.isSubclassSpell,o=e[s].type;if(a)return"Always";return(n?this._isPreparedCantrip(e,s,l):this._isPreparedSpell(e,s,l,a))?"known"===o?"Learned":"Prepared":"known"===o?"Learn":"Prepare"}_countToArray(e){const t=[];for(var s=0;s<e;s++)t.push(null);return t}_toLevel(e){return 0===e?f.a.spLevelToFull(e)+"s":f.a.spLevelToFull(e)+" Level"}_currentSpellsKnownCount(e,t){return t&&e&&t[e]&&t[e].current?t[e].current.length:0}_maxSpellsKnownCount(e,t){return t&&e&&t[e]?t[e].max:0}_currentCantripsKnownCount(e,t){return t&&e&&t[e]&&t[e].current?t[e].currentCantrips.length:0}_maxCantripsKnownCount(e,t){return t&&e&&t[e]?t[e].maxCantrips:0}_toggleTooltip(e){const t=e.target.dataset.tooltip,s=Array.from(e.target.children).find(e=>e.matches(".tooltip"));if(window.tooltipCloseListener||(window.tooltipCloseListener=!0,window.tooltips=[],document.addEventListener("click",()=>{window.tooltips.forEach(e=>{e.classList.remove("tooltip--open"),setTimeout(()=>{e.remove()},300)}),window.tooltips=[]})),s)s.classList.remove("tooltip--open"),setTimeout(()=>{s.remove()},300);else if(t){const s=document.createElement("div");s.innerHTML=t,s.classList.add("tooltip"),e.target.appendChild(s),setTimeout(()=>{s.classList.add("tooltip--open"),window.tooltips.push(s)},0)}}_spellsKnownString(e){return"Spells "+Object(A.util_capitalize)(e)+":"}_isRitualSpell(e){const t=e.children[0];return t&&t.meta&&t.meta.ritual}_isConcentrationSpell(e){return e.children[0].duration.some(e=>e.concentration)}_spellLevel(e){if(e&&e.children&&e.children.length&&e.children[0].level)return f.a.spLevelToFull(e.children[0].level)}_isSpellSlotChecked(e,t){return t<e}_spellClassText(e){return Object(A.util_capitalizeAll)(e)}_isEmpty(e){return!e||!e.length}_hideCheckboxes(e){return!e||e>0&&this.isEditMode}_equal(e,t){return e===t}_hasTwo(e){return e&&e.length&&e.length>1}_join(e){return e.join(", ")}static get template(){return l.b`
    ...
    `}}customElements.define("dnd-character-builder-spells",v)}}]);
