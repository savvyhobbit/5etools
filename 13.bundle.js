(window.webpackJsonp=window.webpackJsonp||[]).push([[13],{103:function(e,t,a){"use strict";a.r(t);var i=a(7),s=(a(63),a(70),a(151));a(77),a(78);class n extends i.a{static get properties(){return{tabs:{type:Array,observer:"tabsChanged"},initialSelectedIndex:{type:Number,value:0,observer:"selectedIndexChange"}}}tabsChanged(){this.tabs.length&&(this.tabBar&&this.$.tabs.removeEventListener("MDCTabBar:activated",this.handleTabChange),setTimeout(()=>{this.tabBar=new s.a(this.$.tabs),this.$.tabs.addEventListener("MDCTabBar:activated",this.handleTabChange),this.tabBar.activateTab(this.initialSelectedIndex)},0))}selectedIndexChange(){this.tabBar&&this.initialSelectedIndex&&this.tabBar.activateTab(this.initialSelectedIndex)}handleTabChange(e){const t=e.detail.index;this.dispatchEvent(new CustomEvent("tabChange",{bubbles:!0,composed:!0,detail:{index:t}}))}static get template(){return i.b`
    ...
    `}}customElements.define("dnd-switch",n)},148:function(e,t,a){var i={"./dnd-character-builder-attributes":[132,3,8],"./dnd-character-builder-attributes.js":[132,3,8],"./dnd-character-builder-background-race":[127,11],"./dnd-character-builder-background-race.js":[127,11],"./dnd-character-builder-class":[134,4,3,9],"./dnd-character-builder-class.js":[134,4,3,9],"./dnd-character-builder-equipment":[135,4,5,10],"./dnd-character-builder-equipment-item-detail":[122,5],"./dnd-character-builder-equipment-item-detail.js":[122,5],"./dnd-character-builder-equipment.js":[135,4,5,10],"./dnd-character-builder-rolls":[130,3,6],"./dnd-character-builder-rolls.js":[130,3,6],"./dnd-character-builder-spells":[131,4,7],"./dnd-character-builder-spells.js":[131,4,7]};function s(e){if(!a.o(i,e))return Promise.resolve().then((function(){var t=new Error("Cannot find module '"+e+"'");throw t.code="MODULE_NOT_FOUND",t}));var t=i[e],s=t[0];return Promise.all(t.slice(1).map(a.e)).then((function(){return a(s)}))}s.keys=function(){return Object.keys(i)},s.id=148,e.exports=s}}]);
