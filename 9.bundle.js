(window.webpackJsonp=window.webpackJsonp||[]).push([[9],{177:function(e,t,a){"use strict";a.r(t);var d=a(3),i=a(31),n=(a(170),a(101),a(165)),s=a(1);class o extends d.a{static get properties(){return{selectedBackground:{type:String,value:""},selectedBackgroundRef:{type:Object},selectedRace:{type:String,value:""},selectedRaceRef:{type:Object},isEditMode:{type:Boolean,value:!1},backgroundName:{type:String,value:""},raceName:{type:String,value:""}}}constructor(){super(),this.additionalOptionAddOptions=["Feat","Attribute +1","Attribute +2","Skill","Language","Tool","Weapon","Armor"]}connectedCallback(){super.connectedCallback(),this.characterChangeHandler=e=>{let t=e.detail.character;this.updateFromCharacter(t)},this.updateFromCharacter(Object(i.O)()),Object(i.m)().addEventListener("character-selected",this.characterChangeHandler),this.editModeHandler=e=>{this.isEditMode=e.detail.isEditMode},Object(n.b)().addEventListener("editModeChange",this.editModeHandler),this.isEditMode=Object(n.c)()}disconnectedCallback(){super.disconnectedCallback(),Object(i.m)().removeEventListener("character-selected",this.characterChangeHandler),Object(n.b)().removeEventListener("editModeChange",this.editModeHandler)}async updateFromCharacter(e){if(e){let t=0,a=Object.entries(e.choices).filter(([e,a])=>{if(e.includes("additionalChoice")&&!e.includes("suboptions")){const d=parseInt(e.substring(e.indexOf("_")+1));return d>t&&(t=d),a?(a.index=d,!0):!1}return!1}).map(([e,t])=>(t.key=e,t));this.maxAdditionalOptionsIndex=t,this.set("additionalOptions",a),e.background?(this.selectedBackground=e.background,this.selectedBackgroundRef=await Object(i.k)(),this.backgroundName=this.selectedBackground.name):(this.selectedBackground={},this.selectedBackgroundRef=void 0,this.backgroundName=""),e.race?(this.selectedRace=e.race,this.selectedRaceRef=await Object(i.N)(),this.raceName=this.selectedRace.name):(this.selectedRace={},this.selectedRaceRef=void 0,this.raceName="")}this.dispatchEvent(new CustomEvent("loadingChange",{bubbles:!0,composed:!0}))}_getRaceLink(e){let t=[e.name];e.source&&t.push(e.source);let a=Object(s.encodeForHash)(t);return e?"#/races/"+a:"#/races"}_getBackgroundLink(e){let t=[e.name];e.source&&t.push(e.source);let a=Object(s.encodeForHash)(t);return e?"#/backgrounds/"+a:"#/backgrounds"}_linkClick(e){const t=e.target.classList.contains("background");this.dispatchEvent(new CustomEvent("open-drawer",{bubbles:!0,composed:!0,detail:{selectedItem:t?this.selectedBackground:this.selectedRace,viewId:t?"backgrounds":"races"}}))}_addAdditionalOption(e){const t=this.$.optionAdd.value;Object(i.a)(t,this.maxAdditionalOptionsIndex+1),this.$.optionAdd.value=""}_deleteAdditionalOption(e){const t=e.model.__data.item.key;Object(i.h)(t)}_showEmpty(e,t){return!e&&!t}_exists(){for(let e of arguments)if(e&&(e.constructor!==Object||Object.entries(e).length>0)&&(!Array.isArray(e)||e.length>0))return!0;return!1}static get template(){return d.b`
