(window.webpackJsonp=window.webpackJsonp||[]).push([[9],{113:function(e,t,s){"use strict";var l=s(7),o=s(69);s(78),s(112);class n extends l.a{static get properties(){return{label:{type:String,value:""},icon:{type:String,value:""},svg:{type:String,value:""},background:{type:String,value:""},border:{type:String,value:""},svgFill:{type:String,value:""},svgStroke:{type:String,value:""}}}connectedCallback(){setTimeout(()=>{this.button=new o.a(this.$.button)},10)}_exists(e){return!!e}_styleStr(e,t,s){let l="";return e&&(l+=`background: ${e}; `),t&&(l+=`border: ${t}; `),l}_svgStyleStr(e,t){let s="";return e&&(s+=`fill: ${e}; `),t&&(s+=`stroke: ${t}; `),s}static get template(){return l.b`
