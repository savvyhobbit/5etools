(window.webpackJsonp=window.webpackJsonp||[]).push([[5],{166:function(t,e,i){"use strict";i(91),i(42);var s=i(103),a=i(56),n=i(2);
/**
 * @license
...
`;Object(n.c)("vaadin-number-field",[a.a,s.a,o],{moduleId:"lumo-number-field"});i(73);var l=i(3),r=i(31),d=i(33),c=i(57),p=i(101),m=i(55),u=i(74);
/**
 * @license
 * Copyright (c) 2021 - 2022 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
...
class b extends h{static get is(){return"vaadin-integer-field"}constructor(){super(),this.allowedCharPattern="[-+\\d]"}_valueChanged(t,e){if(""!==t&&!this.__isInteger(t))return console.warn(`Trying to set non-integer value "${t}" to <vaadin-integer-field>. Clearing the value.`),void(this.value="");super._valueChanged(t,e)}_stepChanged(t,e){if(null!=t&&!this.__hasOnlyDigits(t))return console.warn(`<vaadin-integer-field> The \`step\` property must be a positive integer but \`${t}\` was provided, so the property was reset to \`null\`.`),void(this.step=null);super._stepChanged(t,e)}__isInteger(t){return/^(-\d)?\d*$/.test(String(t))}__hasOnlyDigits(t){return/^\d+$/.test(String(t))}}customElements.define(b.is,b);console.warn('WARNING: Since Vaadin 23.2, "@vaadin/vaadin-text-field" is deprecated. Use "@vaadin/integer-field" instead.')},167:function(t,e,i){"use strict";var s=i(3),a=i(32),n=i(1),o=(i(104),i(37));class l extends s.a{static get properties(){return{options:{type:Array},model:{type:String},addCallback:{type:Function},value:{type:String,value:"",observer:"valueUpdated"},choices:{type:Number,observer:"choicesUpdated"},paren:{type:String},label:{type:String},placeholder:{type:String},multiValue:{type:String,value:""},disabled:{type:Boolean,value:!1,reflectToAttribute:!0}}}choicesUpdated(){this.listBox&&(this.listBox.remove(),delete this.listBox),this.$.select.requestContentUpdate()}valueUpdated(){if(this.choices)if(Array.isArray(this.value)&&this.options){const t=this.value.map(t=>-1!==this.options.indexOf(t)?this.options.indexOf(t):this.options.findIndex(e=>e.name===t.name&&e.source===t.source)).filter(t=>-1!==t);this.listBox&&(this.listBox.selectedValues=t),this.multiValue=t.map(t=>{let e=this.options[t];return e.name?e.name:Object(n.util_capitalizeAll)(e)}).join(", ")}else this.listBox&&(this.listBox.selectedValues=[]),this.multiValue="";else this.value&&this.options?this.value.source?this.$.select.value=this.options.findIndex(t=>t.name===this.value.name&&t.source===this.value.source||t===this.value.name)+"":this.value.name?this.$.select.value=this.options.findIndex(t=>t.name===this.value.name||t===this.value.name)+"":this.$.select.value=this.options.findIndex(t=>t.name===this.value||t===this.value)+"":this.$.select.value=""}ready(){super.ready(),setTimeout(async()=>{this.model&&(this.options=await Object(o.b)(this.model));const t=this.$.select._overlayElement.shadowRoot.querySelector("#content");let e=0;t.addEventListener("scroll",i=>{e=t.scrollTop},{passive:!0}),this.$.select.renderer=(i,s)=>{if(!this.listBox){if(this.listBox=document.createElement("vaadin-list-box"),this.choices&&(this.listBox.setAttribute("multiple",!0),this.listBox.addEventListener("click",i=>{s.opened=!0;let a=null!==i.srcElement.getAttribute("selected");t.scroll(0,e),setTimeout(()=>{this.listBox.selectedValues.length>this.choices&&!a&&this.listBox.selectedValues.splice(this.listBox.selectedValues.length-2,1);let t=this.listBox.selectedValues.map(t=>this.options[t]);this.multiValue=t.map(t=>t.name?t.name:Object(n.util_capitalizeAll)(t)).join(", "),this.addCallback&&this.addCallback(t)},0)})),this.options&&this.options.length)for(let t=0;t<this.options.length;t++){const e=this.options[t],i=document.createElement("vaadin-item"),s=e.name||Object(n.util_capitalizeAll)(e);i.innerHTML=`<span style='margin-left: 10px;'>${s}</span> ${e.name?`<span style='font-size: 14px;color: var(--lumo-primary-color-50pct);'>${e.source||""}</span>`:""}`,i.setAttribute("value",t),this.listBox.appendChild(i)}i.appendChild(this.listBox),this.$.select._assignMenuElement(),this.valueUpdated()}}},0)}connectedCallback(){super.connectedCallback(),this.selectChangeHandler=()=>{const t=this.$.select.value;if(t&&!this.choices){const e=this.options[t];this.addCallback?this.addCallback(e,this.model):Object(a.cb)(void 0,e,this.model),this.value||(this.$.select.value="")}},this.$.select.addEventListener("change",this.selectChangeHandler)}disconnectedCallback(){super.disconnectedCallback(),this.$.select.removeEventListener("change",this.selectChangeHandler)}_exists(t){return!!t}_label(t,e,i){let s="";return t&&(s=t,e&&1!==e&&100!==e&&(s+=` (pick ${e})`),i&&(s+=` (${i})`)),s}static get template(){return s.b`
    ...
    `}}customElements.define("dnd-select-add",l)},175:function(t,e,i){"use strict";i.r(e);var s=i(3),a=(i(166),i(167),i(102),i(124),i(127),i(32)),n=i(72),o=i(1),l=i(105);class r extends s.a{static get properties(){return{str:{type:Number},dex:{type:Number},con:{type:Number},int:{type:Number},wis:{type:Number},cha:{type:Number},strAdj:{type:Number,value:0},dexAdj:{type:Number,value:0},conAdj:{type:Number,value:0},intAdj:{type:Number,value:0},wisAdj:{type:Number,value:0},chaAdj:{type:Number,value:0},skillProfs:{type:String,value:""},customSkillProfs:{type:String},saves:{type:String,value:""},maxHP:{type:Number},tempHP:{type:Number,value:0},isEditMode:{type:Boolean,value:!1},initiative:{type:String,value:""},customInitiative:{type:Boolean,value:!1},customInitiativeVal:{type:Number},customACVal:{type:Number},customACHealth:{type:Number},otherProfsOpen:{type:Boolean},featuresOpen:{type:Boolean},languages:{type:String},toolProfs:{type:String},weaponProfs:{type:String},armorProfs:{type:String},feats:{type:String},darkvision:{type:Number},resists:{type:String},conditionImmunes:{type:String},hasDarkvision:{type:Boolean,value:!1}}}static get observers(){return["updateCharAttr(str, dex, con, int, wis, cha)"]}updateCharAttr(t,e,i,s,n,o){t&&e&&i&&s&&n&&o&&Object(a.Qb)({str:t,dex:e,con:i,int:s,wis:n,cha:o})}hpChangeHandler(t){this.$.hpField.focusElement.blur()}hpBlurHandler(t){const e=parseInt(this.$.hpField.value);Number.isNaN(e)?this.$.hpField.value=a.H:Object(a.pb)(e)}connectedCallback(){super.connectedCallback(),this.characterChangeHandler=t=>{let e=t.detail.character;this.updateAttributesFromCharacter(e)},this.updateAttributesFromCharacter(Object(a.S)()),Object(a.q)().addEventListener("character-selected",this.characterChangeHandler),this.editModeHandler=t=>{this.isEditMode=t.detail.isEditMode},Object(n.b)().addEventListener("editModeChange",this.editModeHandler),this.isEditMode=Object(n.c)()}disconnectedCallback(){super.disconnectedCallback(),Object(a.q)().removeEventListener("character-selected",this.characterChangeHandler),Object(n.b)().removeEventListener("editModeChange",this.editModeHandler)}async updateAttributesFromCharacter(t){if(t&&t.attr){const e=t.attr;e.str===this.str&&e.dex===this.dex&&e.con===this.con&&e.int===this.int&&e.wis===this.wis&&e.cha===this.cha||this.setProperties({str:t.attr.str,dex:t.attr.dex,con:t.attr.con,int:t.attr.int,wis:t.attr.wis,cha:t.attr.cha}),this.saves=(await Object(a.R)()).join(","),this.customSaves=t.customSaves?t.customSaves.join(","):"",this.negatedSaves=t.negatedSaves?t.negatedSaves.join(","):"";let i=await Object(a.n)();this.strAdj=i.str,this.dexAdj=i.dex,this.conAdj=i.con,this.intAdj=i.int,this.wisAdj=i.wis,this.chaAdj=i.cha,this.skillProfs=Object(a.T)().join(","),this.customSkillProfs=t.customSkills?t.customSkills.join(","):"",this.negatedSkillProfs=t.negatedSkills?t.negatedSkills.join(","):"",this.customHealth=!!t.customHealth,this.customHealthVal=t.customHealthVal,this.maxHP=await Object(a.O)(),this.currentHP=await Object(a.H)(),this.tempHP=await Object(a.Y)();const s=await Object(a.L)(),n=[];for(let t of s){const e=n.find(e=>e.die===t.die);e?(0===e.current&&(e.className=t.className),e.current+=t.current,e.total+=t.total):n.push(t)}this.hitDice=n.sort(),this.customAC=!!t.customAC,this.customACVal=t.customACVal,this.ac=await Object(a.p)(),this.customInitiative=!!t.customInitiative,this.customInitiativeVal=t.customInitiativeVal,this.initiative=await Object(a.r)(),this.customSpeed=!!t.customSpeed,this.speed=Object(o.cloneDeep)(await Object(a.t)()),this.additionalCustomSpeedItems=["Fly","Swim","Climb"].filter(e=>!t.customSpeedVal.some(t=>t.type===e.toLowerCase())),this.proficiencyBonus=await Object(a.s)(),this.weaponProfs=Object(a.C)().map(o.util_capitalizeAll).join(", "),this.armorProfs=Object(a.v)().map(o.util_capitalizeAll).join(", "),this.toolProfs=Object(a.B)().map(o.util_capitalizeAll).join(", "),this.languages=Object(a.z)().map(o.util_capitalizeAll).join(", "),this.feats=Object(a.y)().map(o.util_capitalizeAll).join(", "),this.darkvision=Object(a.x)(),this.resists=Object(a.A)().map(o.util_capitalizeAll).join(", "),this.conditionImmunes=Object(a.w)().map(o.util_capitalizeAll).join(", "),this.hasDarkvision=null!==this.darkvision,this.spellMods=await Object(a.U)(t),this.customSpellMod=!!t.customSpellMod,this.customSpellModVal=t.customSpellModVal,this.customSpellDC=!!t.customSpellDC,this.customSpellDCVal=t.customSpellDCVal,this.customSpellAttackBonus=!!t.customSpellAttackBonus,this.customSpellAttackBonusVal=t.customSpellAttackBonusVal,this.dispatchEvent(new CustomEvent("loadingChange",{bubbles:!0,composed:!0}))}}_adjustString(t){return 0!==t&&void 0!==t?Object(o.absInt)(t):""}_total(t,e){let i=parseInt(t),s=parseInt(e);return i=isNaN(i)?0:i,s=isNaN(s)?0:s,i+s}_mod(t,e){return Object(o.absInt)(Math.floor((this._total(t,e)-10)/2))}_contains(t,e){return t.indexOf(e)>-1}_join(t){return t.join(", ")}_abs(t){return t>=0?"+"+t:t}_exists(){for(let t of arguments)if(t&&(t.constructor!==Object||Object.entries(t).length>0)&&(!Array.isArray(t)||t.length>0))return!0;return!1}_editModeClass(t){return t?"edit-mode":"not-edit-mode"}_tempHpStr(t){return t&&"number"==typeof t&&t>0?" + "+t:""}_toggleButtonField(t){const e=t.target.closest(".btn-field"),i=e.classList.contains("btn-field--open"),s=e.classList.contains("btn-field--temp"),n=e.querySelector("vaadin-integer-field"),o=e.querySelector("button");if(e.classList.toggle("btn-field--open"),o.classList.toggle("icon-only"),o.classList.toggle("hard-left"),s)if(i){const t=parseInt(n.value);t&&(Object(a.f)(parseInt(this.tempHP)+t),n.value="")}else n.focus();else if(i){const t=parseInt(n.value);if(t){const i=e.classList.contains("btn-field--heal")?1:-1;Object(a.pb)(parseInt(this.currentHP)+i*t),n.value=""}}else n.focus()}_submitButtonField(t){"Enter"===t.key&&this._toggleButtonField(t)}_blurButtonField(t){this._toggleButtonField(t)}_useHitDice(t){const e=t.target.closest(".hit-dice__item");if(t.model.__data.item.current>0&&this.currentHP<this._maxHP(this.customHealthVal,this.maxHP,this.customHealth)){const t=e.dataset.className;Object(a.Tb)(t)}else e.classList.add("hit-dice__item--error"),setTimeout(()=>{e.classList.remove("hit-dice__item--error")},500)}_strContains(t,e){return(t.match(new RegExp(e,"g"))||[]).length>=1}_strContainsTwo(t,e){return(t.match(new RegExp(e,"g"))||[]).length>=2}_resetHitDice(t){Object(a.jb)()}async _roll(t){const e=Object(o.findInPath)(".proficiency-item",t),i=Object(o.findInPath)(".stat-box__save",t);if(this.isEditMode)e?Object(a.Ib)(e.innerText.toLowerCase()):i&&await Object(a.Hb)(i.getAttribute("attr"));else{const i=Object(o.findInPath)(".stat-box",t),s=Object(o.findInPath)(".initiative",t),a=Object(o.findInPath)(".spellAttack",t);let n,r,d,c;if(e)r=e.hasAttribute("enabled"),c=e.hasAttribute("expertise"),n=parseInt(e.closest(".attribute-wrap").querySelector(".stat-box__mod").innerText,10),d=e.innerText;else if(i)r=i.querySelector(".stat-box__save").hasAttribute("enabled"),n=parseInt(i.querySelector(".stat-box__mod").innerText,10),d=i.querySelector("vaadin-integer-field").label+" Save";else if(s)r=!1,n=this.customInitiative?this.customInitiativeVal:parseInt(this.initiative,10),d="Initiative";else if(a)if(r=!1,this.customSpellAttackBonus)n=this.customSpellAttackBonusVal,d="Spell Attack (Custom)";else if(t.srcElement.classList.contains("mod-val")){const e=t.srcElement.dataset.index;n=this.spellMods[e].spellAttackBonus,d=`Spell Attack (${this.spellMods[e].classes.join(", ")})`}else n=this.spellMods[0].spellAttackBonus,d=`Spell Attack (${this.spellMods[0].classes.join(", ")})`;if(d){let t="1d20";r&&(n+=this.proficiencyBonus),c&&(n+=this.proficiencyBonus),n>0?t+="+"+n:n<0&&(t+=n),Object(l.b)(d,t)}}}_swapCustomInitiative(t){Object(a.Gb)()}_swapCustomSpellMod(t){Object(a.Mb)()}_swapCustomSpellAttackBonus(t){Object(a.Kb)()}_swapCustomSpellDC(t){Object(a.Lb)()}_swapCustomAC(t){Object(a.Eb)()}_swapCustomSpeed(t){Object(a.Jb)()}_swapCustomHealth(t){Object(a.Fb)()}_updateCustomInitiative(t){const e=parseInt(t.currentTarget.value);Object(a.sb)(e)}_updateCustomAC(t){const e=parseInt(t.currentTarget.value);Object(a.qb)(e)}_updateCustomHealth(t){const e=parseInt(t.currentTarget.value);Object(a.rb)(e)}_updateCustomSpellMod(t){const e=parseInt(t.currentTarget.value);Object(a.wb)(e)}_updateCustomSpellDC(t){const e=parseInt(t.currentTarget.value);Object(a.vb)(e)}_updateCustomSpellAttackBonus(t){const e=parseInt(t.currentTarget.value);Object(a.ub)(e)}_removeSpeedItem(t){Object(a.k)(t.model.__data.index)}_addSpeedItem(t){const e={type:t.currentTarget.value.toLowerCase(),speed:0};Object(a.c)(e)}_speedItemChange(t){const e=parseInt(t.currentTarget.value),i=t.model.__data.index;Object(a.l)(i,e)}_plusMinus(t){if(void 0!==t&&t>-1)return"+"}_triggerShortRest(t){}_triggerLongRest(t){}_maxHP(t,e,i){return i?t:e}_toggleOtherProfs(){this.otherProfsOpen=!this.otherProfsOpen}_toggleFeatures(){this.featuresOpen=!this.featuresOpen}_hideCustomSpeed(t,e){return!t||!e}_uppercase(t){return t&&"string"==typeof t?Object(o.util_capitalizeAll)(t):""}_arrayOfOne(t){return Array.isArray(t)&&1===t.length}static get template(){return s.b`
