(window.webpackJsonp=window.webpackJsonp||[]).push([[17],{109:function(e,t,s){"use strict";var n=s(7),r=s(69);s(79),s(125);class i extends n.a{static get properties(){return{label:{type:String,value:""},icon:{type:String,value:""},svg:{type:String,value:""},background:{type:String,value:""},border:{type:String,value:""},svgFill:{type:String,value:""},svgStroke:{type:String,value:""}}}connectedCallback(){setTimeout(()=>{this.button=new r.a(this.$.button)},10)}_exists(e){return!!e}_styleStr(e,t,s){let n="";return e&&(n+=`background: ${e}; `),t&&(n+=`border: ${t}; `),n}_svgStyleStr(e,t){let s="";return e&&(s+=`fill: ${e}; `),t&&(s+=`stroke: ${t}; `),s}static get template(){return n.b`
...
`}static get is(){return"vaadin-grid-sorter"}static get properties(){return{path:String,direction:{type:String,reflectToAttribute:!0,notify:!0,value:null},_order:{type:Number,value:null},_isConnected:{type:Boolean,value:!1}}}static get observers(){return["_pathOrDirectionChanged(path, direction, _isConnected)","_directionOrOrderChanged(direction, _order)"]}ready(){super.ready(),this.addEventListener("click",this._onClick.bind(this))}connectedCallback(){super.connectedCallback(),this._isConnected=!0}disconnectedCallback(){super.disconnectedCallback(),this._isConnected=!1}_pathOrDirectionChanged(e,t,s){void 0!==e&&void 0!==t&&void 0!==s&&s&&this.dispatchEvent(new CustomEvent("sorter-changed",{bubbles:!0,composed:!0}))}_getDisplayOrder(e){return null===e?"":e+1}_onClick(e){const t=this.getRootNode().activeElement;this!==t&&this.contains(t)||(e.preventDefault(),"asc"===this.direction?this.direction="desc":"desc"===this.direction?this.direction=null:this.direction="asc")}_directionOrOrderChanged(e,t){void 0!==e&&void 0!==t&&(/^((?!chrome|android).)*safari/i.test(navigator.userAgent)&&this.root&&this.root.querySelectorAll("*").forEach((function(e){e.style["-webkit-backface-visibility"]="visible",e.style["-webkit-backface-visibility"]=""})))}}customElements.define(g.is,g);s(63),s(72),s(78),s(109);var h=s(11),y=s(1),b=s(5),f=s(0);class A extends n.a{static get properties(){return{columns:{type:Array},listItems:{type:Array},filters:{type:Array},isMobile:{type:Boolean},searchString:{type:String},selectedFilters:{type:Object},resultsCount:{type:Number}}}ready(){super.ready(),setTimeout(()=>{this.$.grid.addEventListener("active-item-changed",e=>{const t=e.detail.value;this.$.grid.selectedItems=t?[t]:[];const s=[t.name];t.source&&s.push(t.source),Object(h.f)(Object(y.encodeForHash)(s))})},0),window.addEventListener("resize",()=>{this._checkBreakpoint(),this._adjustHeight()}),this._checkBreakpoint(),this._adjustHeight(),setInterval(()=>{this._checkBreakpoint(),this._adjustHeight()},500)}_checkBreakpoint(){this.isMobile=window.innerWidth<=768}_adjustHeight(){if(window.innerWidth<921){const e=this.$.grid.getBoundingClientRect().top;e&&(this.$.grid.style.height=window.innerHeight-e-85+"px")}else this.$.grid.style.height="600px"}_renderPath(e){return"render-"+e}_getPathValue(e,t){return e&&e["render-"+t.id]}_filterOptions(e,t){let s=[{label:"",value:""}],n=!1;if(e&&e.length>0)if(e=e.flat(),"proficiencies"===t){n=!0;const e=Object.keys(b.a.SKILL_JSON_TO_FULL).map(e=>({label:e,value:e}));s=s.concat(e)}else if("ability"===t){n=!0;const e=Object.keys(b.a.ATB_ABV_TO_FULL).map(e=>({label:b.a.ATB_ABV_TO_FULL[e],value:e}));s=s.concat({label:'"Any"',value:"any"},e)}else"item-rarity"===t?(n=!0,s=f.z.map(e=>({label:e,value:e}))):"source"===t?e.forEach(e=>{const n=e["render-"+t];s.some(e=>e.value===n)||s.push({label:b.a.sourceJsonToFullCompactPrefix(n)||n,value:n})}):e.forEach(e=>{const n=e["render-"+t];Array.isArray(n)?s=s.concat(n.map(e=>({label:e,value:e}))):"prerequisite"===t&&n.includes("/")?s=s.concat(n.split("/").map(e=>({label:e.trim(),value:e.trim()}))):"monster-type"!==t&&n.includes(",")?s=s.concat(n.split(",").map(e=>({label:e.trim(),value:e.trim()}))):s.push({label:n,value:n})});const r=[];return s=s.filter(e=>!r.includes(e.value)&&(r.push(e.value),!0)),n||(s=s.sort((e,t)=>{const s=e.label,n=t.label,r=Object(y.isFirstCharNum)(s),i=Object(y.isFirstCharNum)(n);if(r&&!i)return 1;if(i&&!r)return-1;if(r&&i){const e=parseFloat(s),t=parseFloat(n);return e<t?-1:e>t?1:0}return s<n?-1:s>n?1:0})),console.error("_filterOptions",s),s}_filterValue(e,t){if(t&&t[e])return t[e]}_selectFilter(e){const t=e.model?e.model.__data.col.id:"name";console.error("_selectFilter",e);const s=this.selectedFilters?Object(y.cloneDeep)(this.selectedFilters):{};s[t]=e.target.value,this.set("selectedFilters",s)}_clearFilters(){this.root.querySelectorAll("vaadin-select, vaadin-grid-filter, vaadin-text-field").forEach(e=>{e.value=""})}_nameColWidth(e){return e?"175px":"300px"}_colWidth(e,t){return t.length&&e===t.length-1?"200px":"175px"}_optionValue(e){return void 0!==e.value?e.value:e}_optionLabel(e){return void 0!==e.label?e.label:e}_optionLabelClass(e,t){return e&&e.value&&t&&"source"===t.id?"source"+e.value:""}_dataItemClass(e,t){return t&&e&&"source"===t.id?"source"+e.source:""}_isLast(e,t){return t.length&&e===t.length-1}static get template(){return n.b`
    ...
    `}}customElements.define("dnd-selection-list",_)},92:function(e,t,s){"use strict";s.r(t);var n=s(7);s(63),s(72),s(124);class r extends n.a{static get template(){return n.b`
    ...
    `}}customElements.define("dnd-cults-view",r)}}]);
