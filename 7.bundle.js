(window.webpackJsonp=window.webpackJsonp||[]).push([[7],{116:function(e,t,s){"use strict";var l=s(7),o=s(69);s(80),s(133);class n extends l.a{static get properties(){return{label:{type:String,value:""},icon:{type:String,value:""},svg:{type:String,value:""},background:{type:String,value:""},border:{type:String,value:""},svgFill:{type:String,value:""},svgStroke:{type:String,value:""}}}connectedCallback(){setTimeout(()=>{this.button=new o.a(this.$.button)},10)}_exists(e){return!!e}_styleStr(e,t,s){let l="";return e&&(l+=`background: ${e}; `),t&&(l+=`border: ${t}; `),l}_svgStyleStr(e,t){let s="";return e&&(s+=`fill: ${e}; `),t&&(s+=`stroke: ${t}; `),s}static get template(){return l.b`
...
</dom-module>`;document.head.appendChild(o.content);var n=s(7),r=(s(32),s(15)),a=s(19),i=s(42),d=s(9);
/**
@license
