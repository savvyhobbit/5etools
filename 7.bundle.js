(window.webpackJsonp=window.webpackJsonp||[]).push([[7],{111:function(e,t,a){"use strict";var i=a(7),o=a(53),d=a(19),n=a(54),l=a(41),r=a(13);
/**
@license
...
</dom-module>`;document.head.appendChild(i.content);a(111)},116:function(e,t,a){"use strict";a(113),a(111)},132:function(e,t,a){"use strict";a.r(t);var i=a(7),o=(a(78),a(116),a(1)),d=a(17),n=a(0),l=a(110),r=a(73);class s extends i.a{static get properties(){return{isEditMode:{type:Boolean,value:!1},customRolls:{type:Array}}}connectedCallback(){super.connectedCallback(),this.damageTypes=n.k,this.characterChangeHandler=e=>{let t=e.detail.character;this.updateFromCharacter(t)},this.updateFromCharacter(Object(d.H)()),Object(d.m)().addEventListener("character-selected",this.characterChangeHandler),this.editModeHandler=e=>{this.isEditMode=e.detail.isEditMode},Object(l.b)().addEventListener("editModeChange",this.editModeHandler),this.isEditMode=Object(l.c)()}disconnectedCallback(){super.disconnectedCallback(),Object(d.m)().removeEventListener("character-selected",this.characterChangeHandler),Object(l.b)().removeEventListener("editModeChange",this.editModeHandler)}async updateFromCharacter(e){this.customRolls=e.customRolls?Object(o.cloneDeep)(e.customRolls):[],this.dispatchEvent(new CustomEvent("loadingChange",{bubbles:!0,composed:!0}))}__exists(){for(let e of arguments)if(e&&(e.constructor!==Object||Object.entries(e).length>0)&&(!Array.isArray(e)||e.length>0))return!0;return!1}__abs(e){return e>=0?"+"+e:e}_makeRoll(e){if(!this.isEditMode){let t=e.model.__data.item;t.noHitRoll||Object(r.d)(t.name+" (to hit)",t.toHit,this.$.advMod.checked,this.$.disadvMod.checked),t.damages.forEach((e,a)=>{setTimeout(()=>{Object(r.b)(`${t.name} (${e.type} damage)`,e.roll)},300*(a+1))})}}_rollChangeHandler(e){const t=Object(o.findInPath)(".roll",e).getAttribute("index"),a=parseInt(t,10);Object(d.hb)(this.customRolls[a],a)}_addRoll(){Object(d.hb)({name:"",toHit:0,noHitRoll:!1,damages:[{roll:"",type:""}]},this.customRolls.length)}_removeRoll(e){const t=Object(o.findInPath)(".roll",e).getAttribute("index"),a=parseInt(t,10);Object(d.S)(a)}_addDamage(e){const t=Object(o.findInPath)(".roll",e).getAttribute("index"),a=parseInt(t,10),i=this.customRolls[a];i.damages.push({roll:"",type:""}),Object(d.hb)(i,a)}_removeDamage(e){const t=Object(o.findInPath)(".roll",e).getAttribute("index"),a=parseInt(t,10),i=Object(o.findInPath)(".roll__damage",e).getAttribute("index"),n=parseInt(i,10);Object(d.T)(a,n)}_or(e,t){return e||t}_orNot(e,t){return e||!t}_isTruthy(e){return!!e}_modChange(e){"advMod"===e.currentTarget.id?this.$.disadvMod.checked=!1:this.$.advMod.checked=!1}static get template(){return i.b`
