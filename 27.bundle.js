(window.webpackJsonp=window.webpackJsonp||[]).push([[27],{110:function(e,t,a){"use strict";a.r(t);var i=a(7),s=(a(63),a(72),a(170));a(82),a(80);class n extends i.a{static get properties(){return{tabs:{type:Array,observer:"tabsChanged"},initialSelectedIndex:{type:Number,value:0,observer:"selectedIndexChange"}}}tabsChanged(){this.tabs.length&&(this.tabBar&&this.$.tabs.removeEventListener("MDCTabBar:activated",this.handleTabChange),setTimeout(()=>{this.tabBar=new s.a(this.$.tabs),this.$.tabs.addEventListener("MDCTabBar:activated",this.handleTabChange),this.tabBar.activateTab(this.initialSelectedIndex)},10))}selectedIndexChange(){this.tabBar&&this.initialSelectedIndex&&this.tabBar.activateTab(this.initialSelectedIndex)}handleTabChange(e){const t=e.detail.index;this.dispatchEvent(new CustomEvent("tabChange",{bubbles:!0,composed:!0,detail:{index:t}}))}static get template(){return i.b`
    ...
    `}}customElements.define("dnd-switch",n)},166:function(e,t,a){var i={"./dnd-character-builder-abilities":[158,0,5],"./dnd-character-builder-abilities.js":[158,0,5],"./dnd-character-builder-attributes":[159,0,10],"./dnd-character-builder-attributes.js":[159,0,10],"./dnd-character-builder-background-race":[160,4,13],"./dnd-character-builder-background-race.js":[160,4,13],"./dnd-character-builder-class":[164,1,0,11],"./dnd-character-builder-class.js":[164,1,0,11],"./dnd-character-builder-equipment":[161,1,8,12],"./dnd-character-builder-equipment-item-detail":[148,9],"./dnd-character-builder-equipment-item-detail.js":[148,9],"./dnd-character-builder-equipment.js":[161,1,8,12],"./dnd-character-builder-rolls":[162,0,6],"./dnd-character-builder-rolls.js":[162,0,6],"./dnd-character-builder-spells":[163,1,0,7],"./dnd-character-builder-spells.js":[163,1,0,7],"./dnd-character-builder-suboptions":[150,4],"./dnd-character-builder-suboptions.js":[150,4]};function s(e){if(!a.o(i,e))return Promise.resolve().then((function(){var t=new Error("Cannot find module '"+e+"'");throw t.code="MODULE_NOT_FOUND",t}));var t=i[e],s=t[0];return Promise.all(t.slice(1).map(a.e)).then((function(){return a(s)}))}s.keys=function(){return Object.keys(i)},s.id=166,e.exports=s}}]);
