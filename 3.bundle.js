(window.webpackJsonp=window.webpackJsonp||[]).push([[3],{166:function(e,t,i){"use strict";i(92),i(42);var a=i(103),l=i(56),n=i(2);
/**
 * @license
...
`;Object(n.c)("vaadin-number-field",[l.a,a.a,o],{moduleId:"lumo-number-field"});i(74);var s=i(3),r=i(31),d=i(32),c=i(57),h=i(102),m=i(55),p=i(75);
/**
 * @license
 * Copyright (c) 2021 - 2022 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
...
i(122).a;console.warn('WARNING: Since Vaadin 23.2, "@vaadin/vaadin-checkbox" is deprecated. Use "@vaadin/checkbox" instead.')},169:function(e,t,i){"use strict";var a=i(3),l=i(165);class n extends a.a{static get properties(){return{initialValue:{type:Boolean,value:!1,observer:"initValueChange"},checked:{type:Boolean,value:!1,reflectToAttribute:!0,notify:!0},label:{type:String,value:""},secondaryLabel:{type:String,value:""},disabled:{type:Boolean,value:!1,reflectToAttribute:!0}}}initValueChange(){this.switchEl&&(this.switchEl.checked=this.initialValue,this.checked=this.initialValue)}ready(){super.ready(),setTimeout(()=>{this.switchEl=new l.a(this.shadowRoot.querySelector(".mdc-switch")),this.switchEl.checked=this.initialValue,this.checked=this.initialValue},10)}connectedCallback(){super.connectedCallback(),this.switchEventHandler=()=>{this.checked=this.switchEl.checked,this.dispatchEvent(new CustomEvent("switch-change",{detail:{checked:this.switchEl.checked},bubbles:!0,composed:!0}))},this.shadowRoot.querySelector(".mdc-switch__native-control").addEventListener("change",this.switchEventHandler)}disconnectedCallback(){super.disconnectedCallback(),this.shadowRoot.querySelector(".mdc-switch__native-control").removeEventListener("change",this.switchEventHandler)}_switchClasses(e){return e?"mdc-switch mdc-list-item__meta mdc-switch--disabled":"mdc-switch mdc-list-item__meta"}static get template(){return a.b`
    ...
    `}}customElements.define("dnd-switch",n)},180:function(e,t,i){"use strict";i.r(t);var a=i(3),l=(i(123),i(167),i(166),i(104),i(1)),n=i(33),o=i(0),s=i(73),r=i(69);i(169);class d extends a.a{static get properties(){return{isEditMode:{type:Boolean,value:!1},customRolls:{type:Array},rolls:{type:Array}}}connectedCallback(){super.connectedCallback(),this.damageTypes=o.k,this.characterChangeHandler=e=>{let t=e.detail.character;this.updateFromCharacter(t)},this.updateFromCharacter(Object(n.T)()),Object(n.q)().addEventListener("character-selected",this.characterChangeHandler),this.editModeHandler=e=>{this.isEditMode=e.detail.isEditMode},Object(s.b)().addEventListener("editModeChange",this.editModeHandler),this.isEditMode=Object(s.c)()}disconnectedCallback(){super.disconnectedCallback(),Object(n.q)().removeEventListener("character-selected",this.characterChangeHandler),Object(s.b)().removeEventListener("editModeChange",this.editModeHandler)}async updateFromCharacter(e){const t=await Object(n.bb)(e),i=Object(n.I)(e),a=await Object(n.W)(e);this.customRolls=i,this.rolls=t.concat(a,i),console.error("rolls",this.rolls),this.dispatchEvent(new CustomEvent("loadingChange",{bubbles:!0,composed:!0}))}__exists(){for(let e of arguments)if(e&&(e.constructor!==Object||Object.entries(e).length>0)&&(!Array.isArray(e)||e.length>0))return!0;return!1}__abs(e){return e>=0?"+"+e:e}_makeRoll(e){if(!this.isEditMode){let t=e.model.__data.item;const i=parseInt(this.$.critOn.value);let a;t.noHitRoll||(a=Object(r.d)(t.name,t.toHit,this.$.advMod.checked,this.$.disadvMod.checked,this.$.doubleAdvMod.checked,i)),t.damages.forEach(e=>{if(e.roll){const i=""+(e.type?Object(l.util_capitalize)(e.type):"Damage");Object(r.b)(t.name,e.roll,i,a)}})}}_rollChangeHandler(e){const t=Object(l.findInPath)(".roll",e).getAttribute("index"),i=parseInt(t,10);Object(n.wb)(this.customRolls[i],i)}_addRoll(){Object(n.wb)({name:"",toHit:0,noHitRoll:!1,damages:[{roll:"",type:""}]},this.customRolls.length),this.isEditMode||Object(s.a)(!0),setTimeout(()=>{const e=this.shadowRoot.querySelectorAll(".roll");e[e.length-1].scrollIntoView()},1)}_removeRoll(e){const t=Object(l.findInPath)(".roll",e).getAttribute("index"),i=parseInt(t,10);Object(n.ib)(i)}_addDamage(e){const t=Object(l.findInPath)(".roll",e).getAttribute("index"),i=parseInt(t,10),a=this.customRolls[i];a.damages.push({roll:"",type:""}),Object(n.wb)(a,i)}_removeDamage(e){const t=Object(l.findInPath)(".roll",e).getAttribute("index"),i=parseInt(t,10),a=Object(l.findInPath)(".roll__damage",e).getAttribute("index"),o=parseInt(a,10);Object(n.jb)(i,o)}_or(e,t){return e||t}_orNot(e,t){return e||!t}_isTruthy(e){return!!e}_modChange(e){"disadvMod"===e.currentTarget.id?(this.$.advMod.checked=!1,this.$.doubleAdvMod.checked=!1):this.$.disadvMod.checked=!1}_hideEditRoll(e,t){return!t||"custom"!==e.type}_hideWarning(e){return"weapon"!==e.type||e.isEquipped&&e.isProficient}_equal(e,t){return e===t}_exists(){for(let e of arguments)if(e&&(e.constructor!==Object||Object.entries(e).length>0)&&(!Array.isArray(e)||e.length>0))return!0;return!1}static get template(){return a.b`
    <style include="material-styles">
      body {}
      :host {
        display: block;
