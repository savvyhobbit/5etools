(window.webpackJsonp=window.webpackJsonp||[]).push([[3],{175:function(e,t,i){"use strict";i(93),i(43);var a=i(104),l=i(58),n=i(3);
/**
 * @license
...
`;Object(n.c)("vaadin-number-field",[l.a,a.a,o],{moduleId:"lumo-number-field"});i(75);var s=i(2),r=i(31),d=i(33),c=i(59),h=i(103),m=i(57),p=i(76);
/**
 * @license
 * Copyright (c) 2021 - 2022 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */
Object(n.c)("vaadin-number-field",p.a,{moduleId:"vaadin-number-field-styles"});class u extends(Object(h.a)(Object(n.a)(Object(r.a)(s.a)))){static get is(){return"vaadin-number-field"}static get template(){return s.b`
      <style>
 ...
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */
class g extends u{static get is(){return"vaadin-integer-field"}constructor(){super(),this.allowedCharPattern="[-+\\d]"}_valueChanged(e,t){if(""!==e&&!this.__isInteger(e))return console.warn(`Trying to set non-integer value "${e}" to <vaadin-integer-field>. Clearing the value.`),void(this.value="");super._valueChanged(e,t)}_stepChanged(e,t){if(null!=e&&!this.__hasOnlyDigits(e))return console.warn(`<vaadin-integer-field> The \`step\` property must be a positive integer but \`${e}\` was provided, so the property was reset to \`null\`.`),void(this.step=null);super._stepChanged(e,t)}__isInteger(e){return/^(-\d)?\d*$/.test(String(e))}__hasOnlyDigits(e){return/^\d+$/.test(String(e))}}customElements.define(g.is,g);console.warn('WARNING: Since Vaadin 23.2, "@vaadin/vaadin-text-field" is deprecated. Use "@vaadin/integer-field" instead.')},176:function(e,t,i){"use strict";i(127);
/**
 * @license
...
i(124).a;console.warn('WARNING: Since Vaadin 23.2, "@vaadin/vaadin-checkbox" is deprecated. Use "@vaadin/checkbox" instead.')},178:function(e,t,i){"use strict";var a=i(2),l=i(174);class n extends a.a{static get properties(){return{initialValue:{type:Boolean,value:!1,observer:"initValueChange"},checked:{type:Boolean,value:!1,reflectToAttribute:!0,notify:!0},label:{type:String,value:""},secondaryLabel:{type:String,value:""},disabled:{type:Boolean,value:!1,reflectToAttribute:!0}}}initValueChange(){this.switchEl&&(this.switchEl.checked=this.initialValue,this.checked=this.initialValue)}ready(){super.ready(),setTimeout(()=>{this.switchEl=new l.a(this.shadowRoot.querySelector(".mdc-switch")),this.switchEl.checked=this.initialValue,this.checked=this.initialValue},10)}connectedCallback(){super.connectedCallback(),this.switchEventHandler=()=>{this.checked=this.switchEl.checked,this.dispatchEvent(new CustomEvent("switch-change",{detail:{checked:this.switchEl.checked},bubbles:!0,composed:!0}))},this.shadowRoot.querySelector(".mdc-switch__native-control").addEventListener("change",this.switchEventHandler)}disconnectedCallback(){super.disconnectedCallback(),this.shadowRoot.querySelector(".mdc-switch__native-control").removeEventListener("change",this.switchEventHandler)}_switchClasses(e){return e?"mdc-switch mdc-list-item__meta mdc-switch--disabled":"mdc-switch mdc-list-item__meta"}static get template(){return a.b`
    ...
    `}}customElements.define("dnd-switch",n)},189:function(e,t,i){"use strict";i.r(t);var a=i(2),l=(i(125),i(176),i(175),i(105),i(1)),n=i(32),o=i(0),s=i(46),r=i(37);i(178);class d extends a.a{static get properties(){return{isEditMode:{type:Boolean,value:!1},customRolls:{type:Array},rolls:{type:Array}}}connectedCallback(){super.connectedCallback(),this.damageTypes=o.k,this.characterChangeHandler=e=>{let t=e.detail.character;this.updateFromCharacter(t)},this.updateFromCharacter(Object(n.U)()),Object(n.q)().addEventListener("character-selected",this.characterChangeHandler),this.editModeHandler=e=>{this.isEditMode=e.detail.isEditMode},Object(s.b)().addEventListener("editModeChange",this.editModeHandler),this.isEditMode=Object(s.c)()}disconnectedCallback(){super.disconnectedCallback(),Object(n.q)().removeEventListener("character-selected",this.characterChangeHandler),Object(s.b)().removeEventListener("editModeChange",this.editModeHandler)}async updateFromCharacter(e){const t=await Object(n.cb)(e),i=Object(n.I)(e),a=await Object(n.X)(e);this.customRolls=i,this.rolls=t.concat(a,i),console.error("rolls",this.rolls),this.dispatchEvent(new CustomEvent("loadingChange",{bubbles:!0,composed:!0}))}__exists(){for(let e of arguments)if(e&&(e.constructor!==Object||Object.entries(e).length>0)&&(!Array.isArray(e)||e.length>0))return!0;return!1}__abs(e){return e>=0?"+"+e:e}_makeRoll(e){if(!this.isEditMode){let t=e.model.__data.item;const i=parseInt(this.$.critOn.value);let a;t.noHitRoll||(a=Object(r.d)(t.name,t.toHit,this.$.advMod.checked,this.$.disadvMod.checked,this.$.doubleAdvMod.checked,i)),t.damages.forEach(e=>{if(e.roll){const i=""+(e.type?Object(l.util_capitalize)(e.type):"Damage");Object(r.b)(t.name,e.roll,i,a)}})}}_rollChangeHandler(e){const t=Object(l.findInPath)(".roll",e).getAttribute("index"),i=parseInt(t,10);Object(n.yb)(this.customRolls[i],i)}_addRoll(){Object(n.yb)({name:"",toHit:0,noHitRoll:!1,damages:[{roll:"",type:""}]},this.customRolls.length),this.isEditMode||Object(s.a)(!0),setTimeout(()=>{const e=this.shadowRoot.querySelectorAll(".roll");e[e.length-1].scrollIntoView()},1)}_removeRoll(e){const t=Object(l.findInPath)(".roll",e).getAttribute("index"),i=parseInt(t,10);Object(n.jb)(i)}_addDamage(e){const t=Object(l.findInPath)(".roll",e).getAttribute("index"),i=parseInt(t,10),a=this.customRolls[i];a.damages.push({roll:"",type:""}),Object(n.yb)(a,i)}_removeDamage(e){const t=Object(l.findInPath)(".roll",e).getAttribute("index"),i=parseInt(t,10),a=Object(l.findInPath)(".roll__damage",e).getAttribute("index"),o=parseInt(a,10);Object(n.kb)(i,o)}_or(e,t){return e||t}_orNot(e,t){return e||!t}_isTruthy(e){return!!e}_modChange(e){"disadvMod"===e.currentTarget.id?(this.$.advMod.checked=!1,this.$.doubleAdvMod.checked=!1):this.$.disadvMod.checked=!1}_hideEditRoll(e,t){return!t||"custom"!==e.type}_hideWarning(e){return"weapon"!==e.type||e.isEquipped&&e.isProficient}_equal(e,t){return e===t}_exists(){for(let e of arguments)if(e&&(e.constructor!==Object||Object.entries(e).length>0)&&(!Array.isArray(e)||e.length>0))return!0;return!1}static get template(){return a.b`
    <style include="material-styles">
      body {}
      :host {
        display: block;
