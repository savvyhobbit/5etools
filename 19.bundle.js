(window.webpackJsonp=window.webpackJsonp||[]).push([[19],{100:function(e,t,s){"use strict";s.r(t);var n=s(7);s(63),s(72),s(132);class r extends n.a{static get template(){return n.b`
    ...
    `}}customElements.define("dnd-feats-view",r)},116:function(e,t,s){"use strict";var n=s(7),r=s(69);s(80),s(133);class i extends n.a{static get properties(){return{label:{type:String,value:""},icon:{type:String,value:""},svg:{type:String,value:""},background:{type:String,value:""},border:{type:String,value:""},svgFill:{type:String,value:""},svgStroke:{type:String,value:""}}}connectedCallback(){setTimeout(()=>{this.button=new r.a(this.$.button)},10)}_exists(e){return!!e}_styleStr(e,t,s){let n="";return e&&(n+=`background: ${e}; `),t&&(n+=`border: ${t}; `),n}_svgStyleStr(e,t){let s="";return e&&(s+=`fill: ${e}; `),t&&(s+=`stroke: ${t}; `),s}static get template(){return n.b`
